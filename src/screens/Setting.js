...
const Setting = ({ navigation }) => {
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      ...
      axios
        .post(
          "http://ec2-13-209-87-211.ap-northeast-2.compute.amazonaws.com/apis/upload",
          formData,
          {
        ...
        >
          ...
          >
            ...
            >
              <View
                style={{
                  backgroundColor: feedbackNum === 1 ? "#A160E2" : "#FDFDFD",
                  borderWidth: 1,
                  borderColor: feedbackNum === 1 ? "#A160E2" : "#F1EFF4",
                  borderRadius: 40,
                  width: 60,
                  height: 20,
                  display: "flex",
              ...
              >
                <Text
                  style={{
                    fontSize: 10,
                    fontWeight: "400",
                    color: feedbackNum === 1 ? "#FDFDFD" : "#B8B5BC",
                    fontFamily: "Poppins-Regular",
                  }}
                >
                  Content
            ...
            >
              <View
                style={{
                  backgroundColor: feedbackNum === 2 ? "#A160E2" : "#FDFDFD",
                  borderWidth: 1,
                  borderColor: feedbackNum === 2 ? "#A160E2" : "#F1EFF4",
                  borderRadius: 40,
                  width: 60,
                  height: 20,
                  display: "flex",
              ...
              >
                <Text
                  style={{
                    fontSize: 10,
                    fontWeight: "400",
                    color: feedbackNum === 2 ? "#FDFDFD" : "#B8B5BC",
                    fontFamily: "Poppins-Regular",
                  }}
                >
                  Bug
            ...
            >
              <View
                style={{
                  backgroundColor: feedbackNum === 3 ? "#A160E2" : "#FDFDFD",
                  borderWidth: 1,
                  borderColor: feedbackNum === 3 ? "#A160E2" : "#F1EFF4",
                  borderRadius: 40,
                  width: 60,
                  height: 20,
                  display: "flex",
              ...
              >
                <Text
                  style={{
                    fontSize: 10,
                    fontWeight: "400",
                    color: feedbackNum === 3 ? "#FDFDFD" : "#B8B5BC",
                    fontFamily: "Poppins-Regular",
                  }}
                >
                  Other
